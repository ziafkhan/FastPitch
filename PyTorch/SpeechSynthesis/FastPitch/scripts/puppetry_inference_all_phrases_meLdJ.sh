...
#  ./scripts/puppetry_inference/meLdJ/inference_puppetry_no_reference.sh $FILE $OUTPUT ${REF_WAVS_LOC}${WAV}.wav
#  cp ${OUTPUT}audio_0.wav ${OUTPUT}${WAV}_synth_no_puppet.wav
#
#  # synthesise after puppeteering pitch and save as such
#  ./scripts/puppetry_inference/meLdJ/inference_puppetry_pitch.sh $FILE $OUTPUT ${REF_WAVS_LOC}${WAV}.wav
...
#  ./scripts/puppetry_inference/meLdJ/inference_puppetry_pitch_dur.sh $FILE $OUTPUT ${REF_WAVS_LOC}${WAV}.wav
...
#  ./scripts/puppetry_inference/meLdJ/inference_puppetry_pitch_energy_dur.sh $FILE $OUTPUT ${REF_WAVS_LOC}${WAV}.wav
...
for WAV_FILE in /media/emelie/EMELIESSD/emphasis_recordings_downsampled22_trimmed/*
do
  echo $WAV_FILE
  WAV_PREFIX=$(basename $WAV_FILE .wav)
  TXT=${WAV_PREFIX/_[OVSQ]/}.txt
  REF_WAVS_LOC='/media/emelie/EMELIESSD/emphasis_recordings_downsampled22_trimmed/'
  PHRASES_LOC='./phrases/puppetry/emphasis/'
  OUTPUT='/media/emelie/EMELIESSD/puppeteering/meLdJ/'
  ...
  # synthesise and save as such
  # 1st argument: phrase, 2nd argument: outputdir,  3rd argument: ref wav
  ./scripts/puppetry_inference/meLdJ/inference_puppetry_no_reference.sh $PHRASES_LOC$TXT $OUTPUT ${WAV_FILE}
  cp ${OUTPUT}audio_0.wav ${OUTPUT}${WAV_PREFIX}_synth_no_puppet.wav

  # synthesise after puppeteering pitch and save as such
  ./scripts/puppetry_inference/meLdJ/inference_puppetry_pitch.sh $PHRASES_LOC$TXT $OUTPUT ${WAV_FILE}
  ...
  # synthesise after puppeteering pitch & dur and save as such
  ./scripts/puppetry_inference/meLdJ/inference_puppetry_pitch_dur.sh $PHRASES_LOC$TXT $OUTPUT ${WAV_FILE}
  cp ${OUTPUT}audio_0.wav ${OUTPUT}${WAV_PREFIX}_synth_pitch_dur.wav

  # synthesise after puppeteering pitch & energy and save as such
  ./scripts/puppetry_inference/meLdJ/inference_puppetry_pitch_energy.sh $PHRASES_LOC$TXT $OUTPUT ${WAV_FILE}
  cp ${OUTPUT}audio_0.wav ${OUTPUT}${WAV_PREFIX}_synth_pitch_energy.wav

  # synthesise after puppeteering dur & energy and save as such

  # synthesise after puppeteering pitch, dur, and energy and save as such
  ./scripts/puppetry_inference/meLdJ/inference_puppetry_pitch_energy_dur.sh $PHRASES_LOC$TXT $OUTPUT ${WAV_FILE}
